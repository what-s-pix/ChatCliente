...
public class ChatGrupoUI extends JFrame {
    ...
    private void pedirHistorial() {
        try {
            // Enviamos el ID del grupo para pedir historial
    ...
    private void enviarMensaje() {
        ...
        // Crear mensaje: El destinatario visual es "GRUPO", pero lo importante es el ID
        Mensaje m = new Mensaje(miUsuario.getUsername(), "GRUPO", texto);
